## Componentes essenciais de um prompt para vídeo

### 1. Técnica de filmagem (ou estilo de captura)
#### Define como o vídeo é feito:
Ex: time-lapse, macro shot, slow motion, handheld camera, one take, stop-motion

### 2. Composição e enquadramento da cena
#### Define o ângulo da câmera e o posicionamento dos elementos no quadro:
Ex: eye-level angle, lower third of the frame, top-down view, wide shot, close-up
